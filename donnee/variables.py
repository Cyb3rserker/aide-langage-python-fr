...
Les différents types de données standard :
    ...
    - booléen (bool) qui ne peut avoir que deux valeurs : True ou False
"""
...
opérations par exemple, et dans ce cas on "cast" la variable, c'est à dire qu'on change son type
temporairement pour que l'interpréteur traite la variable différement. Pour avoir plus de
renseignements, voir aide/donnee/cast.py .
"""
